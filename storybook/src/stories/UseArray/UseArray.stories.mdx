...
- `filter` - The same functionality as JS Array.filter with the results applied to the array state

- `slice` - The same functionality as JS Array.slice with the results applied to the array state

- `sort` - The same functionality as JS Array.sort with the results applied to the array state

- `reverse` - The same functionality as JS Array.reverse with the results applied to the array state
