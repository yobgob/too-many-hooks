...
`,c={play:({canvasElement:t})=>{const a=U(t).getByTitle("like");g.click(a)},parameters:{layout:"centered",controls:{expanded:!0},docs:{source:{code:S,language:"tsx"}}},argTypes:{step:{type:"number"},incrementStep:{type:"number"},decrementStep:{type:"number"}},args:{step:1},render:t=>e(o,{...t})},T=`import React from 'react';
/**
...
`;function b(t={}){const{wrapper:r}=Object.assign({},p(),t.components);return r?e(r,{...t,children:e(a,{})}):a();function a(){const n=Object.assign({h1:"h1",p:"p",h2:"h2",h3:"h3"},p(),t.components);return l(f,{children:[e(A,{title:"Example/UseTally"}),`
...
//# sourceMappingURL=UseTally.stories-849ed6a9.js.map
