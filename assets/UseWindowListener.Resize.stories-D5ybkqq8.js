...
`,m={title:"useWindowListener/Resize",component:a},n={name:"Resize",parameters:{layout:"centered",docs:{source:{code:u,language:"tsx"}}},argTypes:{addResizeAction:{action:(...e)=>e}},render:e=>r.jsx(a,{...e})};var t,s,i;n.parameters={...n.parameters,docs:{...(t=n.parameters)==null?void 0:t.docs,source:{originalSource:`{
  name: 'Resize',
  parameters: {
    layout: 'centered',
    docs: {
