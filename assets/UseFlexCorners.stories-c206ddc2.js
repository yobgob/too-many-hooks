import{M as x,e as g,C,f as y}from"./chunk-MA2MUXQN-17148198.js";import"./chunk-R4NKYYJA-96bb58e6.js";import{j as n,a as b,F as T}from"./jsx-runtime-004bc00d.js";import{r as v}from"./index-b3c7c874.js";import{F as w}from"./too-many-hooks-cd89ca79.js";import{u as d}from"./index-a1245236.js";import"./iframe-5cf682ab.js";import"../sb-preview/runtime.mjs";import"./index-d475d2ea.js";import"./_commonjsHelpers-042e6b4d.js";import"./_getTag-dfdf31e6.js";import"./index-356e4a49.js";const a=({itemCount:r,flexWrap:i,flexDirection:l,justifyContent:o,alignItems:c,alignContent:f})=>{const{corners:e,setElement:m}=w(),h=v.useMemo(()=>Array.from({length:r},(M,t)=>n("div",{ref:p=>p&&m(t,p),className:`flex h-16 ${(t+1)%5===0?"[width:8.25rem]":"w-16"} items-center justify-center bg-blue-700 p-1 text-white  
...
export default Apps
`,u={parameters:{layout:"fullscreen",docs:{source:{code:F,language:"tsx"}}},argTypes:{flexWrap:{options:["wrap","nowrap","wrap-reverse"],control:{type:"select"}},flexDirection:{options:["row","column","row-reverse","column-reverse"],control:{type:"select"}},justifyContent:{options:["start","center","space-between","space-around","space-evenly"],control:{type:"select"}},alignItems:{options:["stretch","center","start","end"],control:{type:"select"}},alignContent:{options:["start","center","space-between","space-around"],control:{type:"select"}}},args:{itemCount:15,flexWrap:"wrap",flexDirection:"row",justifyContent:"start",alignItems:"stretch",alignContent:"start"},render:r=>n(a,{...r})},E=`/**
...
`;function _(r={}){const{wrapper:i}=Object.assign({},d(),r.components);return i?n(i,{...r,children:n(l,{})}):l();function l(){const o=Object.assign({h1:"h1",p:"p",h2:"h2",h3:"h3"},d(),r.components);return b(T,{children:[n(x,{title:"Example/UseFlexCorners"}),`
...
`,n(g,{language:"ts",code:E}),`
`,n(o.h2,{children:"Examples"}),`
`,n(o.h3,{children:"Apps"}),`
`,n(C,{withSource:"open",children:n(y,{name:"Apps",story:u})})]})}}const j=u;j.storyName="Apps";const s={title:"Example/UseFlexCorners",tags:["mdx"],includeStories:["_apps_"]};s.parameters=s.parameters||{};s.parameters.docs={...s.parameters.docs||{},page:_};const k=["_apps_"];export{k as __namedExportsOrder,j as _apps_,s as default};
//# sourceMappingURL=UseFlexCorners.stories-c206ddc2.js.map
