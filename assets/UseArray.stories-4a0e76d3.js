...
`;function ae(r={}){const{wrapper:s}=Object.assign({},W(),r.components);return s?e(s,{...r,children:e(p,{})}):p();function p(){const t=Object.assign({h1:"h1",p:"p",h2:"h2",ul:"ul",li:"li",code:"code",h3:"h3",pre:"pre"},W(),r.components);return n(K,{children:[e(X,{title:"Example/UseArray"}),`
...
`,e(t.pre,{children:e(t.code,{})})]})}}const oe=J;oe.storyName="Burger";const se=$;se.storyName="Bookshelf";const w={title:"Example/UseArray",tags:["mdx"],includeStories:["_burger_","_bookshelf_"]};w.parameters=w.parameters||{};w.parameters.docs={...w.parameters.docs||{},page:ae};const Ne=["_burger_","_bookshelf_"];export{Ne as __namedExportsOrder,se as _bookshelf_,oe as _burger_,w as default};
//# sourceMappingURL=UseArray.stories-4a0e76d3.js.map
