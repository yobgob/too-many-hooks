...
export default Apps
`,_={title:"useFlexCorners/Apps",component:S},d={name:"Apps",parameters:{layout:"fullscreen",docs:{source:{code:D,language:"tsx"}}},argTypes:{flexWrap:{options:["wrap","nowrap","wrap-reverse"],control:{type:"select"}},flexDirection:{options:["row","column","row-reverse","column-reverse"],control:{type:"select"}},justifyContent:{options:["start","center","space-between","space-around","space-evenly"],control:{type:"select"}},alignItems:{options:["stretch","center","start","end"],control:{type:"select"}},alignContent:{options:["start","center","space-between","space-around"],control:{type:"select"}}},args:{itemCount:15,flexWrap:"wrap",flexDirection:"row",justifyContent:"start",alignItems:"stretch",alignContent:"start"},render:a=>g.jsx(S,{...a})};var h,C,y;d.parameters={...d.parameters,docs:{...(h=d.parameters)==null?void 0:h.docs,source:{originalSource:`{
  name: 'Apps',
  parameters: {
    layout: 'fullscreen',
    docs: {
...
}`,...(y=(C=d.parameters)==null?void 0:C.docs)==null?void 0:y.source}}};const $=["apps"],N=Object.freeze(Object.defineProperty({__proto__:null,__namedExportsOrder:$,apps:d,default:_},Symbol.toStringTag,{value:"Module"}));export{N as A,d as a};
