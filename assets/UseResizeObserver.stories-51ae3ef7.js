...
`,e.jsx(d,{withSource:"open",children:e.jsx(u,{name:"Text Area",story:f})})]})}function z(t={}){const{wrapper:r}=Object.assign({},x(),t.components);return r?e.jsx(r,{...t,children:e.jsx(m,{...t})}):m(t)}const _=b;_.storyName="Container Query Emulation";const O=f;O.storyName="Text Area";const a={title:"Example/UseResizeObserver",tags:["stories-mdx"],includeStories:["_containerQuery_","_textArea_"]};a.parameters=a.parameters||{};a.parameters.docs={...a.parameters.docs||{},page:z};const U=["_containerQuery_","_textArea_"];export{U as __namedExportsOrder,_ as _containerQuery_,O as _textArea_,a as default};
//# sourceMappingURL=UseResizeObserver.stories-51ae3ef7.js.map
