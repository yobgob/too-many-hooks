import{j as t}from"./jsx-runtime-QvZ8i92b.js";import{r as T}from"./index-uubelm5h.js";import{u as h}from"./useTally-Ck9qmLPX.js";import{u as r}from"./useThrottleValue-D1BmCzGo.js";const c=()=>{const[e,{increment:s}]=h({}),i=r(e,500),m=r(e,1e3),p=r(e,5e3);return T.useEffect(()=>{const l=()=>{s(),setTimeout(l,1)};setTimeout(l,1)},[s]),t.jsxs("div",{className:"prose flex flex-col gap-2 text-4xl",children:[t.jsxs("div",{children:["Value: ",e]}),t.jsxs("div",{children:["Throttled value (500ms): ",i]}),t.jsxs("div",{children:["Throttled value (1s): ",m]}),t.jsxs("div",{children:["Throttled value (5s): ",p]})]})},d=c;c.__docgenInfo={description:"",methods:[],displayName:"Counter"};const f=`import type React from 'react'
