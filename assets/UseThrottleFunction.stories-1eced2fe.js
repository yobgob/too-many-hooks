...
export default API
`,N="Andorra",h="United Arab Emirates",I="Afghanistan",B="Antigua and Barbuda",g="Anguilla",P="Albania",E="Armenia",R="Netherlands Antilles",y="Angola",L="Antarctica",K="Argentina",F="American Samoa",U="Austria",f="Australia",D="Aruba",H="Azerbaijan",O="Bosnia and Herzegovina",V="Barbados",Z="Bangladesh",b="Belgium",W="Burkina Faso",Y="Bulgaria",J="Bahrain",x="Burundi",w="Benin",k="Saint Barthelemy",_="Bermuda",Q="Brunei",j="Bolivia",z="Brazil",q="Bahamas",X="Bhutan",$="Bouvet Island",aa="Botswana",ea="Belarus",na="Belize",ta="Canada",oa="Cocos Islands",sa="Democratic Republic of the Congo",la="Central African Republic",ca="Republic of the Congo",ua="Switzerland",ra="Ivory Coast",ia="Cook Islands",va="Chile",da="Cameroon",Ma="China",Sa="Colombia",ma="Costa Rica",Aa="Cuba",Ca="Cape Verde",pa="Christmas Island",Ga="Cyprus",Ta="Czech Republic",Na="Germany",ha="Djibouti",Ia="Denmark",Ba="Dominica",ga="Dominican Republic",Pa="Algeria",Ea="Ecuador",Ra="Estonia",ya="Egypt",La="Western Sahara",Ka="Eritrea",Fa="Spain",Ua="Ethiopia",fa="Finland",Da="Fiji",Ha="Falkland Islands",Oa="Micronesia",Va="Faroe Islands",Za="France",ba="Gabon",Wa="United Kingdom",Ya="Grenada",Ja="Georgia",xa="French Guiana",wa="Guernsey",ka="Ghana",_a="Gibraltar",Qa="Greenland",ja="Gambia",za="Guinea",qa="Guadeloupe",Xa="Equatorial Guinea",$a="Greece",ae="South Georgia And Sandwich Isl.",ee="Guatemala",ne="Guam",te="Guinea-Bissau",oe="Guyana",se="Hong Kong",le="Honduras",ce="Croatia",ue="Haiti",re="Hungary",ie="Indonesia",ve="Ireland",de="Israel",Me="Isle of Man",Se="India",me="British Indian Ocean Territory",Ae="Iraq",Ce="Iran",pe="Iceland",Ge="Italy",Te="Jersey",Ne="Jamaica",he="Jordan",Ie="Japan",Be="Kenya",ge="Kyrgyzstan",Pe="Cambodia",Ee="Kiribati",Re="Comoros",ye="Saint Kitts and Nevis",Le="North Korea",Ke="South Korea",Fe="Kuwait",Ue="Cayman Islands",fe="Kazakhstan",De="Laos",He="Lebanon",Oe="Saint Lucia",Ve="Liechtenstein",Ze="Sri Lanka",be="Liberia",We="Lesotho",Ye="Lithuania",Je="Luxembourg",xe="Latvia",we="Libya",ke="Morocco",_e="Monaco",Qe="Moldova",je="Montenegro",ze="Saint Martin",qe="Madagascar",Xe="Marshall Islands",$e="Macedonia",an="Mali",en="Myanmar",nn="Mongolia",tn="Macao",on="Northern Mariana Islands",sn="Martinique",ln="Mauritania",cn="Montserrat",un="Malta",rn="Mauritius",vn="Maldives",dn="Malawi",Mn="Mexico",Sn="Malaysia",mn="Mozambique",An="Namibia",Cn="New Caledonia",pn="Niger",Gn="Norfolk Island",Tn="Nigeria",Nn="Nicaragua",hn="Netherlands",In="Norway",Bn="Nepal",gn="Nauru",Pn="Niue",En="New Zealand",Rn="Oman",yn="Panama",Ln="Peru",Kn="French Polynesia",Fn="Papua New Guinea",Un="Philippines",fn="Pakistan",Dn="Poland",Hn="Saint Pierre and Miquelon",On="Pitcairn",Vn="Puerto Rico",Zn="Palestine",bn="Portugal",Wn="Palau",Yn="Paraguay",Jn="Qatar",xn="Reunion",wn="Romania",kn="Serbia",_n="Russia",Qn="Rwanda",jn="Saudi Arabia",zn="Solomon Islands",qn="Seychelles",Xn="Sudan",$n="Sweden",at="Singapore",et="Saint Helena",nt="Slovenia",tt="Svalbard and Jan Mayen",ot="Slovakia",st="Sierra Leone",lt="San Marino",ct="Senegal",ut="Somalia",rt="Suriname",it="Sao Tome and Principe",vt="El Salvador",dt="Syria",Mt="Swaziland",St="Turks and Caicos Islands",mt="Chad",At="Togo",Ct="Thailand",pt="Tajikistan",Gt="Tokelau",Tt="East Timor",Nt="Turkmenistan",ht="Tunisia",It="Tonga",Bt="Turkey",gt="Trinidad and Tobago",Pt="Tuvalu",Et="Taiwan",Rt="Tanzania",yt="Ukraine",Lt="Uganda",Kt="United States",Ft="Uruguay",Ut="Uzbekistan",ft="Vatican",Dt="Saint Vincent and the Grenadines",Ht="Venezuela",Ot="British Virgin Islands",Vt="U.S. Virgin Islands",Zt="Vietnam",bt="Vanuatu",Wt="Wallis and Futuna",Yt="Samoa",Jt="Yemen",xt="Mayotte",wt="South Africa",kt="Zambia",_t="Zimbabwe",i={AD:N,AE:h,AF:I,AG:B,AI:g,AL:P,AM:E,AN:R,AO:y,AQ:L,AR:K,AS:F,AT:U,AU:f,AW:D,AZ:H,BA:O,BB:V,BD:Z,BE:b,BF:W,BG:Y,BH:J,BI:x,BJ:w,BL:k,BM:_,BN:Q,BO:j,BR:z,BS:q,BT:X,BV:$,BW:aa,BY:ea,BZ:na,CA:ta,CC:oa,CD:sa,CF:la,CG:ca,CH:ua,CI:ra,CK:ia,CL:va,CM:da,CN:Ma,CO:Sa,CR:ma,CU:Aa,CV:Ca,CX:pa,CY:Ga,CZ:Ta,DE:Na,DJ:ha,DK:Ia,DM:Ba,DO:ga,DZ:Pa,EC:Ea,EE:Ra,EG:ya,EH:La,ER:Ka,ES:Fa,ET:Ua,FI:fa,FJ:Da,FK:Ha,FM:Oa,FO:Va,FR:Za,GA:ba,GB:Wa,GD:Ya,GE:Ja,GF:xa,GG:wa,GH:ka,GI:_a,GL:Qa,GM:ja,GN:za,GP:qa,GQ:Xa,GR:$a,GS:ae,GT:ee,GU:ne,GW:te,GY:oe,HK:se,HN:le,HR:ce,HT:ue,HU:re,ID:ie,IE:ve,IL:de,IM:Me,IN:Se,IO:me,IQ:Ae,IR:Ce,IS:pe,IT:Ge,JE:Te,JM:Ne,JO:he,JP:Ie,KE:Be,KG:ge,KH:Pe,KI:Ee,KM:Re,KN:ye,KP:Le,KR:Ke,KW:Fe,KY:Ue,KZ:fe,LA:De,LB:He,LC:Oe,LI:Ve,LK:Ze,LR:be,LS:We,LT:Ye,LU:Je,LV:xe,LY:we,MA:ke,MC:_e,MD:Qe,ME:je,MF:ze,MG:qe,MH:Xe,MK:$e,ML:an,MM:en,MN:nn,MO:tn,MP:on,MQ:sn,MR:ln,MS:cn,MT:un,MU:rn,MV:vn,MW:dn,MX:Mn,MY:Sn,MZ:mn,NA:An,NC:Cn,NE:pn,NF:Gn,NG:Tn,NI:Nn,NL:hn,NO:In,NP:Bn,NR:gn,NU:Pn,NZ:En,OM:Rn,PA:yn,PE:Ln,PF:Kn,PG:Fn,PH:Un,PK:fn,PL:Dn,PM:Hn,PN:On,PR:Vn,PS:Zn,PT:bn,PW:Wn,PY:Yn,QA:Jn,RE:xn,RO:wn,RS:kn,RU:_n,RW:Qn,SA:jn,SB:zn,SC:qn,SD:Xn,SE:$n,SG:at,SH:et,SI:nt,SJ:tt,SK:ot,SL:st,SM:lt,SN:ct,SO:ut,SR:rt,ST:it,SV:vt,SY:dt,SZ:Mt,TC:St,TD:mt,TG:At,TH:Ct,TJ:pt,TK:Gt,TL:Tt,TM:Nt,TN:ht,TO:It,TR:Bt,TT:gt,TV:Pt,TW:Et,TZ:Rt,UA:yt,UG:Lt,US:Kt,UY:Ft,UZ:Ut,VA:ft,VC:Dt,VE:Ht,VG:Ot,VI:Vt,VN:Zt,VU:bt,WF:Wt,WS:Yt,YE:Jt,YT:xt,ZA:wt,ZM:kt,ZW:_t},v={parameters:{layout:"centered",controls:{expanded:!0},docs:{source:{code:T,language:"tsx"}}},argTypes:{firstName:{type:"string"},countryCode:{options:Object.keys(i),control:{type:"select",labels:i}}},args:{firstName:"",countryCode:"US"},render:e=>a(u,{...e})},Qt=`/**
...
`;function jt(e={}){const{wrapper:o}=Object.assign({},r(),e.components);return o?a(o,{...e,children:a(t,{})}):t();function t(){const n=Object.assign({h1:"h1",p:"p",code:"code",h2:"h2",h3:"h3"},r(),e.components);return c(C,{children:[a(M,{title:"Example/UseThrottleFunction"}),`
...
`,a(S,{language:"ts",code:Qt}),`
`,a(n.h2,{children:"Examples"}),`
`,a(n.h3,{children:"API call"}),`
`,a(m,{withSource:"open",children:a(A,{name:"API Call",story:v})})]})}}const zt=v;zt.storyName="API Call";const s={title:"Example/UseThrottleFunction",tags:["mdx"],includeStories:["_api_"]};s.parameters=s.parameters||{};s.parameters.docs={...s.parameters.docs||{},page:jt};const ro=["_api_"];export{ro as __namedExportsOrder,zt as _api_,s as default};
//# sourceMappingURL=UseThrottleFunction.stories-1eced2fe.js.map
