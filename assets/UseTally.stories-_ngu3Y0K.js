...
`,p={play:({canvasElement:t})=>{const r=x(t).getByTitle("like");f.click(r)},parameters:{layout:"centered",controls:{expanded:!0},docs:{source:{code:g,language:"tsx"}}},argTypes:{step:{type:"number"},incrementStep:{type:"number"},decrementStep:{type:"number"}},args:{step:1},render:t=>e.jsx(s,{...t})},S=`import React from 'react';
/**
