...
`,c={play:({canvasElement:t})=>{const s=x(t).getByTitle("like");f.click(s)},parameters:{layout:"centered",controls:{expanded:!0},docs:{source:{code:g,language:"tsx"}}},argTypes:{step:{type:"number"},incrementStep:{type:"number"},decrementStep:{type:"number"}},args:{step:1},render:t=>e.jsx(r,{...t})},S=`import React from 'react';
/**
...
`,e.jsx(y,{withSource:"open",children:e.jsx(h,{name:"Social Media",story:c})})]})}function T(t={}){const{wrapper:n}=Object.assign({},i(),t.components);return n?e.jsx(n,{...t,children:e.jsx(o,{...t})}):o(t)}const b=c;b.storyName="Social Media";const a={title:"Example/UseTally",tags:["stories-mdx"],includeStories:["_socialMedia_"]};a.parameters=a.parameters||{};a.parameters.docs={...a.parameters.docs||{},page:T};const N=["_socialMedia_"];export{N as __namedExportsOrder,b as _socialMedia_,a as default};
//# sourceMappingURL=UseTally.stories-ae473638.js.map
