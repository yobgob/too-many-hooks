...
`,e.jsx(i,{withSource:"open",children:e.jsx(d,{name:"Search books",story:x})})]})}function C(r={}){const{wrapper:t}=Object.assign({},m(),r.components);return t?e.jsx(t,{...r,children:e.jsx(u,{...r})}):u(r)}const N=p;N.storyName="Throttled counter";const k=x;k.storyName="Search books";const n={title:"Example/UseThrottleValue",tags:["stories-mdx"],includeStories:["_counter_","_search_"]};n.parameters=n.parameters||{};n.parameters.docs={...n.parameters.docs||{},page:C};const I=["_counter_","_search_"];export{I as __namedExportsOrder,N as _counter_,k as _search_,n as default};
