...
`,p={play:({canvasElement:t})=>{const r=x(t).getByTitle("like");B.click(r)},parameters:{layout:"centered",controls:{expanded:!0},docs:{source:{code:U,language:"tsx"}}},argTypes:{step:{type:"number"},incrementStep:{type:"number"},decrementStep:{type:"number"}},args:{step:1},render:t=>e.jsx(s,{...t})},S=`import React from 'react';
/**
...
`,e.jsx(y,{withSource:"open",children:e.jsx(h,{name:"Social Media",story:p})})]})}function T(t={}){const{wrapper:n}=Object.assign({},i(),t.components);return n?e.jsx(n,{...t,children:e.jsx(o,{...t})}):o(t)}const b=p;b.storyName="Social Media";const a={title:"Example/UseTally",tags:["stories-mdx"],includeStories:["_socialMedia_"]};a.parameters=a.parameters||{};a.parameters.docs={...a.parameters.docs||{},page:T};const O=["_socialMedia_"];export{O as __namedExportsOrder,b as _socialMedia_,a as default};
