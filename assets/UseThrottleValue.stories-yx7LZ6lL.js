import{M as y,e as v,C as i,f as d}from"./chunk-HLWAVYOI-LzjbuYRw.js";import{j as e}from"./jsx-runtime-vNq4Oc-g.js";import{B as T,N as a}from"./too-many-hooks-L1FzWKig.js";import{r as h}from"./index-4g5l5LRQ.js";import{B as g}from"./book-names-A1ViUjO4.js";import{useMDXComponents as m}from"./index-_VGcpBFS.js";import"./iframe-yzUvUhI0.js";import"../sb-preview/runtime.js";import"./react-18-4cA3wSg4.js";import"./_commonjsHelpers-4gQjN7DL.js";import"./index-hJ3u4GB4.js";import"./index-TRu6N6dU.js";import"./index-PPLHz8o0.js";const l=()=>{const[r,{increment:t}]=T({}),s=a(r,500),o=a(r,1e3),f=a(r,5e3);return h.useEffect(()=>{const c=()=>{t(),setTimeout(c,1)};setTimeout(c,1)},[t]),e.jsxs("div",{className:"prose flex flex-col gap-2 text-4xl",children:[e.jsxs("div",{children:["Value: ",r]}),e.jsxs("div",{children:["Throttled value (500ms): ",s]}),e.jsxs("div",{children:["Throttled value (1s): ",o]}),e.jsxs("div",{children:["Throttled value (5s): ",f]})]})};try{l.displayName="Counter",l.__docgenInfo={description:"",displayName:"Counter",props:{}}}catch{}const _=`import { useTally, useThrottleValue } from '@yobgob/too-many-hooks'
...
`,e.jsx(i,{withSource:"open",children:e.jsx(d,{name:"Search books",story:x})})]})}function N(r={}){const{wrapper:t}=Object.assign({},m(),r.components);return t?e.jsx(t,{...r,children:e.jsx(u,{...r})}):u(r)}const C=p;C.storyName="Throttled counter";const k=x;k.storyName="Search books";const n={title:"Example/UseThrottleValue",tags:["stories-mdx"],includeStories:["_counter_","_search_"]};n.parameters=n.parameters||{};n.parameters.docs={...n.parameters.docs||{},page:N};const I=["_counter_","_search_"];export{I as __namedExportsOrder,C as _counter_,k as _search_,n as default};
