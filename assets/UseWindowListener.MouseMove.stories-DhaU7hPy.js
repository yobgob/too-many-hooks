import{j as a}from"./jsx-runtime-QvZ8i92b.js";import{u as d}from"./useWindowListener-Dx7QUJ2Z.js";const u=({addMouseMoveAction:e})=>(d("mousemove",n=>e(`Mouse moved to (${n.clientX}, ${n.clientY})`,n)),a.jsx("div",{className:"prose text-4xl",children:'Move your mouse around to trigger listener events, viewable in the "Actions" tab'})),i=u;u.__docgenInfo={description:"",methods:[],displayName:"MouseMove",props:{addMouseMoveAction:{required:!0,tsType:{name:"signature",type:"function",raw:"(...data: unknown[]) => void",signature:{arguments:[{type:{name:"Array",elements:[{name:"unknown"}],raw:"unknown[]"},name:"data",rest:!0}],return:{name:"void"}}},description:""}}};const c=`import React from 'react'
