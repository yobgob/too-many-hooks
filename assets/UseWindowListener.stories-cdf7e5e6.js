import{M as l,e as v,C as r,f as d}from"./chunk-S4VUQJ4A-3a24bb92.js";import{j as e}from"./jsx-runtime-42309cba.js";import{z as p}from"./too-many-hooks-3e7bc8b7.js";import{u as c}from"./index-f90265c0.js";import"./iframe-edfb3508.js";import"../sb-preview/runtime.js";import"./index-546ee486.js";import"./_commonjsHelpers-de833af9.js";import"./index-d475d2ea.js";import"./index-d37d4223.js";import"./index-356e4a49.js";const s=({addMouseMoveAction:n})=>(p("mousemove",o=>n(`Mouse moved to (${o.clientX}, ${o.clientY})`,o)),e.jsx("div",{className:"prose text-4xl",children:'Move your mouse around to trigger listener events, viewable in the "Actions" tab'}));try{s.displayName="MouseMove",s.__docgenInfo={description:"",displayName:"MouseMove",props:{addMouseMoveAction:{defaultValue:null,description:"",name:"addMouseMoveAction",required:!0,type:{name:"(...data: unknown[]) => void"}}}}}catch{}const w=`import { useWindowListener } from '@yobgob/too-many-hooks'
...
`,e.jsx(r,{withSource:"open",children:e.jsx(d,{name:"Resize",story:m})})]})}function M(n={}){const{wrapper:o}=Object.assign({},c(),n.components);return o?e.jsx(o,{...n,children:e.jsx(a,{...n})}):a(n)}const y=u;y.storyName="MouseMove";const g=m;g.storyName="Resize";const t={title:"Example/UseWindowListener",tags:["stories-mdx"],includeStories:["_mouseMove_","_resize_"]};t.parameters=t.parameters||{};t.parameters.docs={...t.parameters.docs||{},page:M};const k=["_mouseMove_","_resize_"];export{k as __namedExportsOrder,y as _mouseMove_,g as _resize_,t as default};
//# sourceMappingURL=UseWindowListener.stories-cdf7e5e6.js.map
