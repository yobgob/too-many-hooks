import{j as e}from"./jsx-runtime-QvZ8i92b.js";import{r as u}from"./index-uubelm5h.js";import{u as m}from"./useResizeObserver-Wph4RNl-.js";const i=()=>{const[t,l]=u.useState(null),o=m(t);return e.jsxs("div",{className:"prose flex flex-col items-center gap-4",children:[e.jsx("p",{children:"Resize to change the flow of content"}),e.jsxs("div",{ref:d=>l(d),className:`flex h-80 w-80 resize gap-4 overflow-auto border border-slate-800 bg-slate-200 p-4 ${o&&o[0].contentRect.width<300?"flex-col":""}`,children:[e.jsx("div",{className:"flex-1 rounded border border-slate-500 bg-white"}),e.jsx("div",{className:"flex-1 rounded border border-slate-500 bg-white"})]})]})},c=i;i.__docgenInfo={description:"",methods:[],displayName:"ContainerQuery"};const p=`import type React from 'react'
...
`,f={title:"UseResizeObserver/ContainerQuery",component:c},r={name:"Container Query",parameters:{layout:"centered",docs:{source:{code:p,language:"tsx"}}},render:t=>e.jsx(c,{...t})};var s,n,a;r.parameters={...r.parameters,docs:{...(s=r.parameters)==null?void 0:s.docs,source:{originalSource:`{
