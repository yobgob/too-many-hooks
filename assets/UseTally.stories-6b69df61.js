...
`,c={play:({canvasElement:t})=>{const a=B(t).getByTitle("like");U.click(a)},parameters:{layout:"centered",controls:{expanded:!0},docs:{source:{code:S,language:"tsx"}}},argTypes:{step:{type:"number"},incrementStep:{type:"number"},decrementStep:{type:"number"}},args:{step:1},render:t=>e(o,{...t})},T=`import React from 'react';
/**
...
`;function F(t={}){const{wrapper:r}=Object.assign({},p(),t.components);return r?e(r,{...t,children:e(a,{})}):a();function a(){const n=Object.assign({h1:"h1",p:"p",h2:"h2",h3:"h3"},p(),t.components);return l(f,{children:[e(A,{title:"Example/UseTally"}),`
...
`,e(y,{withSource:"open",children:e(h,{name:"Social Media",story:c})})]})}}const b=c;b.storyName="Social Media";const s={title:"Example/UseTally",tags:["mdx"],includeStories:["_socialMedia_"]};s.parameters=s.parameters||{};s.parameters.docs={...s.parameters.docs||{},page:F};const X=["_socialMedia_"];export{X as __namedExportsOrder,b as _socialMedia_,s as default};
//# sourceMappingURL=UseTally.stories-6b69df61.js.map
