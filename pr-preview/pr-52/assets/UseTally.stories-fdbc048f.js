...
`,c={play:({canvasElement:t})=>{const a=U(t).getByTitle("like");g.click(a)},parameters:{layout:"centered",controls:{expanded:!0},docs:{source:{code:S,language:"tsx"}}},argTypes:{step:{type:"number",defaultValue:1},incrementStep:{type:"number"},decrementStep:{type:"number"}},render:t=>e(o,{...t})},T=`import React from 'react';
/**
...
`;function b(t={}){const{wrapper:r}=Object.assign({},p(),t.components);return r?e(r,{...t,children:e(a,{})}):a();function a(){const n=Object.assign({h1:"h1",p:"p",h2:"h2",h3:"h3"},p(),t.components);return l(B,{children:[e(A,{title:"Example/UseTally"}),`
...
`,e(y,{withSource:"open",children:e(h,{name:"Social Media",story:c})})]})}}const F=c;F.storyName="Social Media";const s={title:"Example/UseTally",tags:["mdx"],includeStories:["_socialMedia_"]};s.parameters=s.parameters||{};s.parameters.docs={...s.parameters.docs||{},page:b};const X=["_socialMedia_"];export{X as __namedExportsOrder,F as _socialMedia_,s as default};
//# sourceMappingURL=UseTally.stories-fdbc048f.js.map
