...
`,z={parameters:{layout:"fullscreen",backgrounds:{default:"light",values:[{name:"light",value:"white"}]},docs:{source:{code:ne,language:"tsx"}}},render:r=>e(D,{...r})},J={parameters:{layout:"centered",docs:{source:{code:ee,language:"tsx"}}},render:r=>e(x,{...r})},oe=`/**
...
`;function ae(r={}){const{wrapper:i}=Object.assign({},W(),r.components);return i?e(i,{...r,children:e(p,{})}):p();function p(){const t=Object.assign({h1:"h1",p:"p",h2:"h2",ul:"ul",li:"li",code:"code",h3:"h3",pre:"pre"},W(),r.components);return n(K,{children:[e(Y,{title:"Example/UseArray"}),`
...
`,e(t.pre,{children:e(t.code,{})})]})}}const le=z;le.storyName="Burger";const ie=J;ie.storyName="Bookshelf";const w={title:"Example/UseArray",tags:["mdx"],includeStories:["_burger_","_bookshelf_"]};w.parameters=w.parameters||{};w.parameters.docs={...w.parameters.docs||{},page:ae};const Re=["_burger_","_bookshelf_"];export{Re as __namedExportsOrder,ie as _bookshelf_,le as _burger_,w as default};
//# sourceMappingURL=UseArray.stories-94542c4c.js.map
