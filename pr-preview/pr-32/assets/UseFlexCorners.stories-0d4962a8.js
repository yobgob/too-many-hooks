...
`,n(C,{withSource:"open",children:n(y,{name:"Apps",story:u})})]})}}const j=u;j.storyName="Apps";const s={title:"Example/UseFlexCorners",tags:["mdx"],includeStories:["_apps_"]};s.parameters=s.parameters||{};s.parameters.docs={...s.parameters.docs||{},page:_};const Y=["_apps_"];export{Y as __namedExportsOrder,j as _apps_,s as default};
//# sourceMappingURL=UseFlexCorners.stories-0d4962a8.js.map
