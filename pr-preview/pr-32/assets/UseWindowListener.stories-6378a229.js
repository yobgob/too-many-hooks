...
`,e(d,{withSource:"open",children:e(p,{name:"Resize",story:v})})]})}}const x=l;x.storyName="MouseMove";const f=v;f.storyName="Resize";const i={title:"Example/UseWindowListener",tags:["mdx"],includeStories:["_mouseMove_","_resize_"]};i.parameters=i.parameters||{};i.parameters.docs={...i.parameters.docs||{},page:W};const F=["_mouseMove_","_resize_"];export{F as __namedExportsOrder,x as _mouseMove_,f as _resize_,i as default};
//# sourceMappingURL=UseWindowListener.stories-6378a229.js.map
