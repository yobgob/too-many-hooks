...
`,U={parameters:{layout:"fullscreen",backgrounds:{default:"light",values:[{name:"light",value:"white"}]},docs:{source:{code:X,language:"tsx"}}},render:a=>e(M,{...a})};function q(a={}){const{wrapper:p}=Object.assign({},D(),a.components);return p?e(p,{...a,children:e(m,{})}):m();function m(){const t=Object.assign({h1:"h1",p:"p",h2:"h2",ul:"ul",li:"li",code:"code",pre:"pre",h3:"h3"},D(),a.components);return n($,{children:[e(z,{title:"Example/UseArray"}),`
...
`]}),`
`,n(t.li,{children:[`
`,n(t.p,{children:[e(t.code,{children:"filter"})," - The same functionality as JS Array.filter with the results applied to the array state"]}),`
`]}),`
`,n(t.li,{children:[`
`,n(t.p,{children:[e(t.code,{children:"slice"})," - The same functionality as JS Array.slice with the results applied to the array state"]}),`
`]}),`
`,n(t.li,{children:[`
`,n(t.p,{children:[e(t.code,{children:"sort"})," - The same functionality as JS Array.sort with the results applied to the array state"]}),`
`]}),`
`,n(t.li,{children:[`
`,n(t.p,{children:[e(t.code,{children:"reverse"})," - The same functionality as JS Array.reverse with the results applied to the array state"]}),`
`]}),`
`]}),`
...
`,e(V,{withSource:"open",children:e(J,{name:"Burger",story:U})}),`
`,e(t.pre,{children:e(t.code,{})})]})}}const H=U;H.storyName="Burger";const w={title:"Example/UseArray",tags:["mdx"],includeStories:["_burger_"]};w.parameters=w.parameters||{};w.parameters.docs={...w.parameters.docs||{},page:q};const ye=["_burger_"];export{ye as __namedExportsOrder,H as _burger_,w as default};
//# sourceMappingURL=UseArray.stories-3ec43a48.js.map
